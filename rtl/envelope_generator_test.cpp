...
TEST_CASE_METHOD(Fixture, "envelope: Single length instrument", "[envelope-generator]")
{
    static uint16_t ROM[] = {
        // Instrument Lengths
        /* 0x00 */  LENGTHS(1,  1,  1,  1),
        /* 0x01 */  LENGTHS(1,  1,  1,  1),
        /* 0x02 */  LENGTHS(1,  1,  1,  1),
        /* 0x03 */  LENGTHS(1,  1,  1,  1),
